...
static void trs_reset(struct TimeRangeSignal *_this)
{
	memset(_this->idxes, -1, sizeof(_this->idxes));
	_this->flags = 0;
}
static bool trs_maybeError(struct TimeRangeSignal *_this)
{
	return _this->flags;
}
static void trs_setMaybeError(struct TimeRangeSignal *_this, bool _val)
{
	_this->flags = _val;
}
...
static struct FrequencyMatch *fi_realTimes(struct FrequencyInfo *_this)
{
	return _this->realTimes;
}
static int fi_realTimesCount(struct FrequencyInfo *_this)
{
	return _this->realEventCount;
}
static struct FrequencyMatch *fi_realTimesFirst(struct FrequencyInfo *_this)
{
	assert(_this->realEventCount > 0);
	return _this->realTimes;
}
static struct FrequencyMatch *fi_realTimesLast(struct FrequencyInfo *_this)
{
	return _this->realTimes + (_this->realEventCount - 1);
}
static struct FrequencyMatch *fi_times(struct FrequencyInfo *_this)
{
	return _this->realTimes + _this->timesStart;
}
static int fi_timesCount(struct FrequencyInfo *_this)
{
	return _this->timesEnd - _this->timesStart;
}
static struct FrequencyMatch *fi_timesFirst(struct FrequencyInfo *_this)
{
...
static struct FrequencyMatch *fi_timesLast(struct FrequencyInfo *_this)
{
	assert(_this->realEventCount > 0 && _this->timesStart >= 0 && _this->timesStart < _this->timesEnd && _this->timesStart < _this->realEventCount && _this->timesEnd <= _this->realEventCount);
	return _this->realTimes+(_this->timesEnd-1);
}
static void fi_timesPollFirst(struct FrequencyInfo *_this)
{
	assert(_this->timesStart < _this->timesEnd);
	_this->timesStart ++;
}
static void fi_timesClear(struct FrequencyInfo *_this)
{
...
static tidx iei_idx(struct Idx2EventInfo *_this)
{
	return _this->end;
}

static void iei_add(struct Idx2EventInfo *_this, const struct EventInfo *_event)
{
...
static struct EventInfo *iei_curr(struct Idx2EventInfo *_this)
{
	return _this->events + ((_this->end-1) % _this->size);
}

static tidx iei_minIdx(struct Idx2EventInfo *_this)
{
	return _this->end - _this->size + 1;
}

static tidx iei_currIdx(struct Idx2EventInfo *_this)
{
	return _this->end - 1;
}

static struct EventInfo* iei_get(struct Idx2EventInfo *_this, tidx _idx)
{
	_idx = _idx - 1;
...
static void sa_setMinRegcoSignalCount(struct SignalAnalyser *_this, int minRegcoSignalCount)
{
...
static int sa_getMinFreqIdx(struct SignalAnalyser *_this)
{
	return _this->ampsRange.minFreqIdx;
}

static int sa_getMaxFreqIdx(struct SignalAnalyser *_this)
{
	return _this->ampsRange.maxFreqIdx;
}

static TRecognitionListener sa_getListener(struct SignalAnalyser *_this)
{
	return _this->listener;
}

static void sa_setListener(struct SignalAnalyser *_this, TRecognitionListener listener)
{
