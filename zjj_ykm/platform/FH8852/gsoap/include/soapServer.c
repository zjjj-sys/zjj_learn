...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.55 2017-12-08 01:22:00 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "SOAP-ENV:Fault-ahuo"))
		return soap_serve_SOAP_ENV__Fault_ahuo(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_SOAP_ENV__Fault_ahuo(struct soap *soap)
{	struct SOAP_ENV__Fault_ahuo soap_tmp_SOAP_ENV__Fault_ahuo;
	soap_default_SOAP_ENV__Fault_ahuo(soap, &soap_tmp_SOAP_ENV__Fault_ahuo);
	if (!soap_get_SOAP_ENV__Fault_ahuo(soap, &soap_tmp_SOAP_ENV__Fault_ahuo, "SOAP-ENV:Fault-ahuo", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = SOAP_ENV__Fault_ahuo(soap, soap_tmp_SOAP_ENV__Fault_ahuo.faultcode, soap_tmp_SOAP_ENV__Fault_ahuo.faultstring, soap_tmp_SOAP_ENV__Fault_ahuo.faultactor, soap_tmp_SOAP_ENV__Fault_ahuo.detail, soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Code, soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Reason, soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Node, soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Role, soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Detail);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}
