...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.55 2017-12-08 01:22:00 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_send_SOAP_ENV__Fault_ahuo(struct soap *soap, const char *soap_endpoint, const char *soap_action, char *faultcode, char *faultstring, char *faultactor, struct SOAP_ENV__Detail *detail, struct SOAP_ENV__Code *SOAP_ENV__Code, struct SOAP_ENV__Reason *SOAP_ENV__Reason, char *SOAP_ENV__Node, char *SOAP_ENV__Role, struct SOAP_ENV__Detail *SOAP_ENV__Detail)
{	struct SOAP_ENV__Fault_ahuo soap_tmp_SOAP_ENV__Fault_ahuo;
	soap_tmp_SOAP_ENV__Fault_ahuo.faultcode = faultcode;
	soap_tmp_SOAP_ENV__Fault_ahuo.faultstring = faultstring;
	soap_tmp_SOAP_ENV__Fault_ahuo.faultactor = faultactor;
	soap_tmp_SOAP_ENV__Fault_ahuo.detail = detail;
	soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Code = SOAP_ENV__Code;
	soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Reason = SOAP_ENV__Reason;
	soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Node = SOAP_ENV__Node;
	soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Role = SOAP_ENV__Role;
	soap_tmp_SOAP_ENV__Fault_ahuo.SOAP_ENV__Detail = SOAP_ENV__Detail;
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_SOAP_ENV__Fault_ahuo(soap, &soap_tmp_SOAP_ENV__Fault_ahuo);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_SOAP_ENV__Fault_ahuo(soap, &soap_tmp_SOAP_ENV__Fault_ahuo, "SOAP-ENV:Fault-ahuo", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv_SOAP_ENV__Fault_ahuo(struct soap *soap, struct SOAP_ENV__Fault_ahuo *_param_1)
{
	soap_default_SOAP_ENV__Fault_ahuo(soap, _param_1);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get_SOAP_ENV__Fault_ahuo(soap, _param_1, "SOAP-ENV:Fault-ahuo", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_OK;
	if (soap->error
	 || soap_body_end_in(soap)
